...
<head>
    ...
    <title>TimeTable Document Generator</title>
...
<body>
<div class="navbar navbar-inverse navbar-top " id="menu">
    <div class="container">
        <div align="center">
			<img src="assets/img/download.png" alt="Chania">
            <h3 align="center">TIME TABLE GENERATER, COMPUTER SCIENCE & ENGINEERING DEPARTMENT,RNGPIT</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/download.jpg" alt="Chania">
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/image.png" class="img-rounded"/>
                    <h3 align="center">Prof. ABC</h3>
                    <hr/>
                    <h4 align="center">Head Of Dept.<br/>CS&E Department</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/image.png" class="img-rounded"/>
                    <h3 align="center">Prof. DEF</h3>
                    <hr/>
                    <h4 align="center">Assistant Prof.<br/> CS&E Department</h4>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4>Bardoli – Navsari Road,</h4>
				<h4>At: Isroli PO : Afwa</h4>
				<h4>Tal : Bardoli – 394620</h4>
				<h4>Dist: Surat</h4>
				<h4>State : Gujarat</h4>
                <h4><strong>Call:</strong> +91 9512900457, +91 9512900458 </h4>
                <h4><strong>Email: </strong>rngpit.bardoli@gmail.com</h4>
				<h4 ><strong>Website: </strong><a href="http://rngpit.ac.in/">http://rngpit.ac.in/</a></h4>
            </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1"
            ...
            <hr/>
            <div>
                <a href="https://www.facebook.com/RNGPIT"> <img src="assets/img/Social/facebook.png" alt=""/> </a>
                <a href="https://www.youtube.com/channel/UCoFRKtJoEB4YEazTC2U43Hw"> <img src="assets/img/Social/youtube.png" alt=""/></a>
                <a href="https://www.instagram.com/rngpit_bardoli/"> <img src="assets/img/Social/instagram.jpg" alt=""/> </a>
            </div>
        </div>
